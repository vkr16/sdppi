    ...
    <div class="offcanvas-lg offcanvas-start custom-sidebar bg-light text-dark" data-bs-scroll="true" tabindex="-1" id="sidebarPanelOffCanvas" aria-labelledby="sidebarPanelOffCanvasLabel" style=" min-width: 250px;width: 250px;max-width: 250px;">
        <div class="custom-sidebar bg-light text-dark vh-100 scrollable-y hide-scrollbar px-2">
            <a href="#home" class="py-3 mb-3 container-fluid d-flex gap-2 align-items-center sticky-top bg-light text-dark border-bottom border-light border-opacity-25 text-decoration-none" id="sidebar-header">
                <img src="<?= base_url('public/assets/img') ?>/logo-banner.png" alt="" class="w-100">
            </a>

            <ul class="list-unstyled m-0 p-0">
                <li>
                    <a href="<?= base_url() ?>/admin/" class="mb-2 px-3 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark  sidebar-item text-decoration-none" id="sidebar-item-dashboard">
                ...
                <li>
                    ...
                    <div class="collapse" id="management-collapse">
                        <ul class="btn-toggle-nav list-unstyled">
                            <li>
                                <a href="<?= base_url() ?>/admin/pos" class="mb-2 ps-5 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark sidebar-item  text-decoration-none" id="sidebar-item-pos">
                                    <div class=" m-0"> <i class="fa-solid fa-truck-fast fa-fw"></i> &nbsp; Pos</div>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>/admin/telekomunikasi" class="mb-2 ps-5 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark sidebar-item  text-decoration-none" id="sidebar-item-telekomunikasi">
                                    <div class=" m-0"> <i class="fa-solid fa-tower-cell fa-fw"></i> &nbsp; Telekomunikasi</div>
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url() ?>/admin/penyiaran" class="mb-2 ps-5 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark sidebar-item  text-decoration-none" id="sidebar-item-penyiaran">
                ...
                <li>
                    <a href="<?= base_url() ?>/admin/informasi" class="mb-2 px-3 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark sidebar-item  text-decoration-none" id="sidebar-item-informasi">
                        <div class=" m-0"> <i class="fa-solid fa-circle-info fa-fw"></i> &nbsp; Manajemen Informasi</div>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url() ?>/admin/faq" class="mb-2 px-3 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark sidebar-item  text-decoration-none" id="sidebar-item-faq">
                        <div class=" m-0"> <i class="fa-solid fa-clipboard-question fa-fw"></i> &nbsp; Manajemen FAQ</div>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url() ?>/admin/pengguna" class="mb-2 px-3 py-2 rounded container-fluid d-flex gap-2 align-items-center sticky-top text-dark sidebar-item  text-decoration-none" id="sidebar-item-pengguna">
