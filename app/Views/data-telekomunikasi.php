    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-md-10 col-lg-8 offset-md-1 offset-lg-2 container  mb-5">
                ...
                <p class="text-center mt-2 lh-sm"> Data berikut ini terakhir diperbarui pada <?= $lastUpdate[0]['content'] ?>
                </p>
            </div>
                    ...
                    <table id="telekomunikasi-table" class="table  table-hover">
                        ...
                        <tbody>
                            <?php foreach ($telekomunikasiDataArray as $index => $telekomunikasi) { ?>
                                <tr>
                                    <td></td>
                                    <td><?= $telekomunikasi['nama']; ?></td>
                                    <td><?= $telekomunikasi['jenis_layanan']; ?></td>
                                    <td><?= $telekomunikasi['domisili']; ?></td>
                                    <td><?= $telekomunikasi['status']; ?></td>
